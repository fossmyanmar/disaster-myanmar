				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu dropdown-custom dropdown-menu-right">
						...
						<li>
							...
							<a href="{!! URL::route('admin.setting') !!}"><i class="fa fa-cog fa-fw pull-right"></i>Settings</a>
						</li>
						<li class="divider"></li>
						<li>
							<a href="{!! URL::route('admin.logout') !!}"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
						</li>
					</ul>
				</li>
			</ul>
